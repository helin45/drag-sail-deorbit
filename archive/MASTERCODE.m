%% =========================================================================
%  DRAG SAIL ATTITUDE DYNAMICS + STATISTICAL AVERAGING MODEL (SAM)
% =========================================================================
clear; clc; close all;
clear functions

addpath('/Users/helintaha/Library/CloudStorage/OneDrive-TheUniversityofManchester/Dissertation/MASTERCODE/adbsat_processed/350km');
addpath('/Users/helintaha/Library/CloudStorage/OneDrive-TheUniversityofManchester/Dissertation/MASTERCODE/adbsat_processed/450km');
addpath('/Users/helintaha/Library/CloudStorage/OneDrive-TheUniversityofManchester/Dissertation/MASTERCODE/adbsat_processed/650km');
